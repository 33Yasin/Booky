...
const Navbar = ({
  onLoginClick,
  showUserMenu = false, // Boolean to toggle between Login button and User Menu
  onLogoutClick = () => {},
  onSearch = () => {},
  cartCount = 0,
  onCartClick = () => {},
  ...
  // Initialize theme state. Checks localStorage or system preference.
  ...
  // Effect to apply theme changes to the HTML element and sync with localStorage
  React.useEffect(() => {
  ...
  // Function to toggle between light and dark themes with animation
  const toggleTheme = () => {
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between h-16 w-full">
          ...
          <div className="flex-shrink-0 flex items-center gap-2">
            ...
            {/* Conditional Rendering: User Menu vs Login Button */}
            {showUserMenu ? (
